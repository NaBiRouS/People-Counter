...
from src.monitoring.metrics import (
    JOBS_CREATED,
    API_REQUESTS, API_REQUEST_DURATION,
)
...
async def monitor_requests(request: Request, call_next):
    """
    Measure API request count and duration.
    ...
    Returns:
        The HTTP response generated by the API.
    """
    ...
    try:
        ...
        # Record unexpected API errors as HTTP 500 responses
        status_code = 500

        # Use the request path if no route was matched
        endpoint = request.url.path

        raise

    finally:
        # Record the number of requests with method, endpoint, and status code labels
        API_REQUESTS.labels(
        ...
        # Record the request duration with method and endpoint labels
